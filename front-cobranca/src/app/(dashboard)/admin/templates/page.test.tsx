...
const mockApi={getTemplates:jest.fn(),getEmailTemplates:jest.fn(),submitTemplateToMeta:mockSubmit,syncTemplateMetaStatuses:mockSync,financialAdmin:mockFinancial};
